 ...
 *
 * Třída {@link AbstractResult} implementuje rozhraní {@link cz.hlavja.ir.data.Result}
 *
 * Představuje výsledek pro ohodnocené vyhledávání. Tzn. po zadání dotazu vyhledávač vrátí
 * "List<Result>", kde každý objekt {@link cz.hlavja.ir.data.Result} reprezentuje jeden dokument a jeho relevanci k zadanému dotazu.
 ...
 *
 * Od této třídy byste měli dědit pokud vám nestačí implementace třídy {@link cz.hlavja.ir.data.ResultImpl}, např. pokud potřebujete
